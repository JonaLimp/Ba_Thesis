...
def get_dataloader(num_train=0, valid=.1, num_test=0, label='fine'):
	...
	if label == 'fine':
        ...
        y_train = np.concatenate([y_train_fine[...,None],y_train_coarse[...,None]],2)
        y_test = np.concatenate([y_test_fine[...,None],y_test_coarse[...,None]],2)
	...
	num_val_samples = int(num * valid)

	x_val = x_train[:num_val_samples]
	partial_x_train= x_train[num_val_samples:num]

	y_val = y_train[:num_val_samples]
	partial_y_train = y_train[num_val_samples:num]
